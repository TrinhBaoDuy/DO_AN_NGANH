...
//                .antMatchers(HttpMethod.GET, "/api/**").access("hasRole('ROLE_ADMIN') or hasRole('ROLE_SICKPERSON') or hasRole('ROLE_DOCTOR')or hasRole('ROLE_NURSE')")
//                .antMatchers(HttpMethod.POST, "/api/**").access("hasRole('ROLE_ADMIN') or hasRole('ROLE_SICKPERSON')or hasRole('ROLE_DOCTOR')or hasRole('ROLE_NURSE')")
//                .antMatchers(HttpMethod.DELETE, "/api/**").access("hasRole('ROLE_ADMIN') or hasRole('ROLE_SICKPERSON') or hasRole('ROLE_DOCTOR')or hasRole('ROLE_NURSE')")
